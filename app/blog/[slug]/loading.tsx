import { ThemeProvider } from "@/components/BlogTheme";
			...
			<main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-16">
				<div className="flex flex-wrap items-center justify-between gap-2">
					...
					<div className="flex items-center gap-1 rounded-full border border-lavender-border bg-lavender p-1">
						<Skeleton className="h-6 w-16 rounded-full bg-ink/10" />
						<Skeleton className="h-6 w-12 rounded-full bg-ink/10" />
						<Skeleton className="h-6 w-12 rounded-full bg-ink/10" />
					</div>
				</div>

				<Skeleton className="mx-auto mt-6 h-10 w-64 bg-ink/10 sm:h-14 sm:w-80" />
				<Skeleton className="mx-auto mt-8 h-4 w-48 bg-ink/10 rounded" />
				...
				<section className="mt-20">
					<Skeleton className="h-6 w-32 bg-ink/10" />
